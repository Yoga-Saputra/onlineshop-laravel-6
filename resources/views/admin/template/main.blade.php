...
<head>
    ...
    <!-- Bootstrap CSS-->
    <link href="{{asset('admin/vendor/bootstrap/bootstrap.min.css')}}" rel="stylesheet">
...
<body class="animsition">
    <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="index.html">
                            Admin
                            {{-- <img src="{{asset('admin/images/icon/logo.png')}}" alt="Admin" /> --}}
                        </a>
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="chart.html"><i class="fas fa-archive"></i>product</a>
                        </li>
                        <li>
                            <a href="chart.html"><i class="fas fa-archive"></i>categories</a>
                        </li>
                        <li>
                            <a href="#">
                        ...
                        <li>
                            <a href="#"><i class="fas fa-wrench"></i>Setting</a>
                        </li>
                    </ul>
                </div>
            </nav>
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <h2 class="text-center"><a href="#">ADMIN</a></h2>
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        <li>
                                <a href="#"><i class="fas fa-tachometer-alt"></i>Dashboard
                                </a>
                        </li>
                        <li>
    ...
    <!-- Bootstrap JS-->
    <script src="{{asset('admin/vendor/bootstrap/popper.min.js')}}"></script>
