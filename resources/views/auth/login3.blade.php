...
<head>
    ...
    <!-- ICONS -->
    <link rel="apple-touch-icon" sizes="76x76" href="{{asset('admin/img/3.png')}}">
    <link rel="icon" type="image/png" sizes="96x96" href="{{asset('admin/img/3.png')}}">
</head>
                ...
                <div class="auth-box ">
                    ...
                    <div class="right">
                        ...
                        <div class="content text">
                            <h1 class="heading text-center">Aplikasi Pengelolaan Data Siswa</h1>
                            <p class="text-center">by</p>
                            <p class="text-center">Nurays</p>
                        </div>
                    </div>
